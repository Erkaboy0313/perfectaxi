    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('busy', 'Busy'), ('blocked', 'Block')], default='busy', max_length=20)),
                ...
                ('mark', models.FloatField(blank=True, default=5)),
                ('generated_default_mark', models.BooleanField(blank=True, default=False)),
                ('car_color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.color')),
                ('car_images', models.ManyToManyField(related_name='car_images', to='users.documentimages')),
                ('car_model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.carbrend')),
                ('car_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='category.carmodel')),
